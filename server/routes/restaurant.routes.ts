...
import type { RedisPublisher } from "../utils/redis/publisher.js";

export const restaurantRouter = (publisher: RedisPublisher) => {
  ...
  router.post("/", validate(RestaurantSchema), async (req, res, next) => {
    ...
    try {
      ...
      publisher.publish("newRestaurantChannel", "New restaurant added, let check them out!");
